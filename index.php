			...
			<div class="timeline">
			  ...
			  <div class="timeline-item is-dark">
			    ...
			    <div class="timeline-content">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more2">+</button>
			  ...
			  <div class="timeline-item is-dark">
			    ...
			    <div class="timeline-content">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more3">+</button>
			  ...
			  <div class="timeline-item is-dark">
			    ...
			    <div class="timeline-content">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more4">+</button>
			  ...
			  <div class="timeline-item is-dark">
			    ...
			    <div class="timeline-content">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more5">+</button>
			  ...
			  <div class="timeline-item is-dark studies" id="studies">
			    ...
			    <div class="timeline-content is-dark">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more6">+</button>
			  ...
			  <div class="timeline-item is-dark">
			    ...
			    <div class="timeline-content is-dark">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more7">+</button>
			  ...
			  <div class="timeline-item is-dark">
			    ...
			    <div class="timeline-content is-dark">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more8">+</button>
			  ...
			  <div class="timeline-item is-dark">
			    ...
			    <div class="timeline-content is-dark">
			      ...
			      <button type="button" class="button is-small is-rounded is-primary is-outlined" id="more9">+</button>
